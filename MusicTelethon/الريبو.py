...
async def restart(client, m: Message):
    ...
    await loli.edit("8")
    await loli.edit("9")
    await loli.edit("**✅ تم اعاده تشغيل موسيقى سورس المطور حسن البصراوي")
...
𝘰𝘳𝘥𝘦𝘳𝘴 𝘮𝘶𝘴𝘪𝘤 [ المهندس حسن البصراوي ](t.me/blackbirdd)
——————×—————
...
⧉ | لتشغيل الاغنية عشوائية من قناة او مجموعة  ⇦ [ `{HNDLR}اغنيه عشوائيه` ]
———————×———————
